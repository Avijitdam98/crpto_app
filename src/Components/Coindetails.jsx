      ...
      {loading ? (
        ...
        <>
          ...
          <VStack spacing={"4"} p="16" alignItems={"flex-start"}>
            ...
            <Image
              src={coin.image?.large || "fallback_image_url"}
              w={"16"}
              h={"16"}
              objectFit={"contain"}
            />
            ...
            <CustomBar
              high={`${currencySymbol}${
                coin.market_data?.high_24h?.[currency] || "N/A"
              }`}
              low={`${currencySymbol}${
                coin.market_data?.low_24h?.[currency] || "N/A"
              }`}
            />
            ...
            <Box w={"full"} p="4">
              ...
              <Item
                ...
                value={`${currencySymbol}${
                  coin.market_data?.market_cap?.[currency] || "N/A"
                }`}
              />
              <Item
                title={"All Time Low"}
                value={`${currencySymbol}${
                  coin.market_data?.atl?.[currency] || "N/A"
                }`}
              />
              <Item
                title={"All Time High"}
                value={`${currencySymbol}${
                  coin.market_data?.ath?.[currency] || "N/A"
                }`}
              />
            </Box>
          </VStack>
